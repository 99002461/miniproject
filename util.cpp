...
void printNewMemberInformation(Member *member)
{
    ...
    println(blueBold("DL no.") + ":" + __space(maxLen - 2) + member->getId());
...
void printNewBookInformation(Book *book)
{
    ...
    println(blueBold("Manufactuer Name") + ":" + __space(maxLen - 11) + book->getAuthor());
    println(blueBold("Lincense Plate number") + ":" + __space(maxLen - 4) + book->getISBN());
    println(blueBold("Delpoyed year") + ":" + __space(maxLen - 12) + to_string(book->getPublishYear()));
...
void printBorrowedBookInformation(Book *book)
{
    ...
    println(pinkBold("Manufactuer Name") + ":" + __space(maxLen - 11) + book->getAuthor());
    println(pinkBold("Lincense Plate number") + ":" + __space(maxLen - 4) + book->getISBN());
    println(pinkBold("Deployed Year") + ":" + __space(maxLen - 12) + to_string(book->getPublishYear()));
...
void printRegisteredBookInformation(Book *book)
{
    ...
    println(blueBold("Name") + ":" + __space(maxLen - 4) + book->getName());
    println(blueBold("Manufactuer Name") + ":" + __space(maxLen - 11) + book->getAuthor());
    println(blueBold("Licence Plate number") + ":" + __space(maxLen - 4) + book->getISBN());
    println(blueBold("Deployed Year") + ":" + __space(maxLen - 12) + to_string(book->getPublishYear()));
    println(blueBold("Total") + ":" + __space(maxLen - 5) + to_string(book->getTotal()));
    println(blueBold("Rented") + ":" + __space(maxLen - 8) + to_string(book->getTotal() - book->getRemainingCount()));
...
void printRegisteredMemberInformation(Member *member)
{
    ...
    println(blueBold("Last Name") + ":" + __space(maxLen - 9) + member->getLastName());
    println(blueBold("Entrance Year") + ":" + __space(maxLen - 13) + to_string(member->getEntranceYear()));
    println(blueBold("Number of Rented Cars") + ":" + __space(maxLen - 24) + to_string(member->getBorrowedBooksCount()));
}
